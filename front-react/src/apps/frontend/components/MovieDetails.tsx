...
export const MovieDetails: React.FC<Props> = ({repository}) => {
  ...
  return(
    <main className="movie-details">
      <section>
        <figure>
          <img src={movie.horizontalImagePath} />
        </figure>
        <h2>{movie.title}</h2>
        <aside>
          <p>
